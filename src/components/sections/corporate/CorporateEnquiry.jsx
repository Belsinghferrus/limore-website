...
const APPS_SCRIPT_URL = process.env.NEXT_PUBLIC_CORPORATE_ENQUIRY_URL
...
const t = {
  ...
  ar: {
    ...
    successSub:  'تم إرسال تأكيد إلى بريدك الإلكتروني.',
  ...
  fr: {
    ...
    successSub:  'Une confirmation a été envoyée à votre adresse e-mail.',
...
function InputField({ label, type = 'text', value, onChange, required, isRTL, placeholder = '', autoComplete = 'off' }) {
...
// ─── Success state ─────────────────────────────────────────────────────────────
function SuccessPanel({ message, sub }) {
...
function SectionDivider({ label }) {
  return (
    <div style={{
      ...
      <div style={{ width: '16px', height: '1px', backgroundColor: '#C41E1E', flexShrink: 0 }} />
      <span style={{
        fontSize:      '8px',
        fontFamily:    "'Inter', sans-serif",
        fontWeight:    500,
    ...
    >
      <div style={{
        ...
        <div ref={leftRef} style={{ opacity: 0 }}>
          ...
          {/* Process steps */}
          <div style={{ display: 'flex', flexDirection: 'column', marginBottom: 'clamp(32px,5vw,48px)' }}>
            {c.steps.map((step, i) => (
              <div key={i} style={{
                display:      'flex',
                alignItems:   'center',
                ...
                <div style={{ width: '20px', height: '1px', backgroundColor: '#E0E0E0', flexShrink: 0 }} />
                <span style={{
        ...
        <div ref={formRef} style={{ opacity: 0 }}>
          {status === 'success' ? (
            <SuccessPanel message={c.success} sub={c.successSub} />
          ) : (
            <div style={{
              backgroundColor: '#FFFFFF',
              borderTop:       '2px solid #C41E1E',
              ...
              >
                ...
                {/* ── Section C: Company & Programme ── */}
                <SectionDivider label="Company & Programme" />
