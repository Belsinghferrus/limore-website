...
function CarIcon({ animate }) {
  return (
    ...
    >
      <path d="M4 18H48V22H4z" fill={SURFACE} stroke="rgba(255,255,255,0.12)" strokeWidth="0.8"/>
      <path d="M12 18L16 10H36L40 18z" fill={SURFACE} stroke="rgba(255,255,255,0.15)" strokeWidth="0.8"/>
      <path d="M18 17L20.5 11.5H30L32 17z" fill="rgba(200,16,46,0.18)" stroke="rgba(200,16,46,0.3)" strokeWidth="0.6"/>
      <circle cx="15" cy="22" r="4" fill="#1a1a1a" stroke="rgba(255,255,255,0.2)" strokeWidth="0.8"/>
      <circle cx="15" cy="22" r="1.8" fill={RED}
        style={{ transformOrigin: '15px 22px', animation: animate ? 'nudge-spin 0.4s linear infinite' : 'none' }}/>
      <circle cx="37" cy="22" r="4" fill="#1a1a1a" stroke="rgba(255,255,255,0.2)" strokeWidth="0.8"/>
      ...
      {animate && <path d="M48 19.5L54 17L48 20.5" fill="rgba(255,249,196,0.15)" />}
      {animate && (
        <>
...
function ChauffeurIcon({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      <path d="M3 16c0-3.314 2.686-6 6-6s6 2.686 6 6" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/>
...
function ArrowIcon({ size = 12 }) {
  return (
    <svg width={size} height={size * 0.67} viewBox="0 0 12 8" fill="none" aria-hidden="true">
      <path d="M1 4h10M7 1l4 3-4 3" stroke="currentColor" strokeWidth="1.1"
...
export default function BookingNudge({ locale = 'en' }) {
  ...
  // ─── Positioning ───────────────────────────────────────────────────────────
  // Full card: bottom-right (desktop) / bottom sheet (mobile)
  // Minimised pill: sits directly above the WhatsApp FAB (bottom: 96px = 56px FAB + 16px gap + 24px base)
  ...
  return (
    <>
      <style>{`
        @keyframes nudge-right-in {
          from { opacity:0; transform:translateX(32px) scale(0.96); }
          to   { opacity:1; transform:translateX(0) scale(1); }
        }
        @keyframes nudge-right-out {
          from { opacity:1; transform:translateX(0); }
          to   { opacity:0; transform:translateX(32px); }
        }
        @keyframes nudge-left-in {
          from { opacity:0; transform:translateX(-32px) scale(0.96); }
          to   { opacity:1; transform:translateX(0) scale(1); }
        }
        @keyframes nudge-left-out {
          from { opacity:1; transform:translateX(0); }
          to   { opacity:0; transform:translateX(-32px); }
        }
        @keyframes nudge-mobile-in {
          from { opacity:0; transform:translateY(100%); }
          to   { opacity:1; transform:translateY(0); }
        }
        @keyframes nudge-mobile-out {
          from { opacity:1; transform:translateY(0); }
          to   { opacity:0; transform:translateY(100%); }
        }
        @keyframes nudge-pill-in {
        ...
        @keyframes nudge-badge-in {
          0%   { transform:scale(0) rotate(-8deg); opacity:0; }
          70%  { transform:scale(1.1) rotate(2deg); opacity:1; }
          100% { transform:scale(1) rotate(0deg); opacity:1; }
        }
        @keyframes nudge-pill-pulse {
      ...
      >
        ...
        {!minimised && (
          <div style={{
            ...
            borderLeft:      isMobile ? 'none' : `1px solid rgba(255,255,255,0.09)`,
            ...
            <div style={{
              ...
              <div>
                ...
                <span style={{
                  fontSize:'9px', fontFamily:FONT_B, fontWeight:400,
            ...
            {/* Content */}
            <div style={{ padding: isMobile ? '18px 20px 28px' : '18px 20px 20px' }}>
              ...
              <div style={{
                ...
                <div style={{ display:'flex', alignItems:'center', gap:'9px' }}>
                  ...
                  <h2 style={{
                    ...
                    fontFamily: FONT_D, fontWeight:300, color:TEXT,
              ...
              <p style={{
                ...
                fontFamily:FONT_B, fontWeight:300, lineHeight:1.8,
              ...
              <div style={{
                ...
                <Link
                  ...
                  style={{
                    ...
                    boxShadow:      ctaHover ? '0 4px 20px rgba(200,16,46,0.4)' : '0 2px 10px rgba(200,16,46,0.2)',
                    background:     ctaHover
