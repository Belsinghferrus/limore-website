  ...
  return (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
      <path d="M1 1l10 10M11 1L1 11"
        stroke={MUTED} strokeWidth="1.3" strokeLinecap="round"/>
    </svg>
  )
}
...
export default function BookingNudge({ locale = 'en' }) {
  ...
  // Car animation loop when visible
  useEffect(() => {
    if (!visible) return
    const loop = () => {
      setCarAnimate(true)
  ...
  const posStyle = isMobile
    ...
    : { bottom: '32px', left: isRTL ? '24px' : 'auto', right: isRTL ? 'auto' : '24px', width: '320px' }
            ...
            <div style={{
              ...
              <Link
                ...
                style={{
                  ...
                  backgroundColor: ctaHover ? RED_DARK : RED,
                  color:           'white',
                  textDecoration:  'none',
                  fontSize:        '10px',
                  fontFamily:      FONT_B,
