...
function CalendarPanel({ value, min, onChange }) {
  ...
  const selectedStr = value // 'YYYY-MM-DD' or ''
  ...
  return (
    <div style={{ padding: '16px 16px 12px' }}>
      ...
      <div style={{
        ...
        <button onClick={prevMonth} aria-label="Previous month"
          style={{ background:'none', border:`1px solid ${BORDER}`, color:MUTED,
            ...
            justifyContent:'center', cursor:'pointer', borderRadius:'0',
            transition:'all 0.2s',
          }}
        ...
        <span style={{
          fontSize:'11px', fontFamily:FONT_D, fontWeight:400,
      ...
      <div style={{
        ...
        {DAYS.map(d => (
          <div key={d} style={{
            textAlign:'center', fontSize:'8px', fontFamily:FONT_B,
            fontWeight:500, letterSpacing:'0.1em',
            color:FAINT, padding:'4px 0', textTransform:'uppercase',
          }}>
            {d}
          </div>
        ))}
          ...
          return (
            <button
              ...
              style={{
                ...
                border:          isToday && !isSelected ? `1px solid rgba(200,16,46,0.4)` : '1px solid transparent',
                color:           isPast ? FAINT : isSelected ? 'white' : TEXT,
...
function TimePanel({ value, onChange }) {
  ...
  return (
    <div style={{ padding:'16px' }}>
      {/* Label */}
      <div style={{
        fontSize:'8px', fontFamily:FONT_B, fontWeight:500,
      ...
      <div style={{ display:'flex', gap:'8px', alignItems:'flex-start' }}>
        ...
        <div style={{ flex:1 }}>
          <div style={{
            fontSize:'8px', fontFamily:FONT_B, color:FAINT,
        ...
        {/* Divider */}
        <div style={{
          alignSelf:'center', color:MUTED,
          fontSize:'16px', fontFamily:FONT_D, marginTop:'20px',
        }}>:</div>
...
export default function DateTimePicker({
  ...
  // Automatically switch to time tab after date picked
  ...
  // Today's date string as default min
  const today    = new Date()
  ...
  return (
    <div ref={ref} style={{ position:'relative', direction:dir }}>
      ...
      >
        ...
        {/* Right: clock icon if time set */}
        {timeValue && (
          <span style={{ color:RED, flexShrink:0, display:'flex' }}>
            <ClockIcon />
          </span>
        )}
      </button>
        ...
        <div style={{
          ...
          {dateValue && timeValue && (
            <div style={{
              ...
              <span style={{
                fontSize:'10px', fontFamily:FONT_B, fontWeight:300,
